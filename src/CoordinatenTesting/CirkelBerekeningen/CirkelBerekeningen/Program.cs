...
namespace CirkelBerekeningen
{
    class Program
    {
        ...
        private static double EPSILON = 0.15;
                                                 ...
                                                 double x2, double y2, double r2, double x3, double y3, double r3)
        {
            ...
            */
            ...
            {
                Console.WriteLine("INTERSECTION Circle1 AND Circle2 AND Circle3: (" + intersectionPoint2_x + ":" + intersectionPoint2_y + ")"); //here was an error
            }
            else
            {
